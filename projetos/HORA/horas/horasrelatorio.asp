...
<script type="text/javascript" src="js/horasrelatorio.js"></script>
...
<table class="font" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="VERTICAL-ALIGN: top">
			<form name="thisForm" action="horasrelatorioprint.asp" method="post">
									...
									If Not vobj_rs.EOF Then
										...
										If vint_ContadorRegistroRS = 2 Then
											...
											<tr style="cursor: hand" class="tr<%=contadorClass Mod 2 %>">
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%=converterDataParaHtml(vobj_rs("DT_DATA"))%></td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%=DesencriptaString(vobj_rs("HR_ENTRADA"))%></td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%=DesencriptaString(vobj_rs("HR_SAIDA"))%></td>
												<%
												...
												%>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%=DesencriptaString(vobj_rs("HR_ENTRADA"))%></td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%
												...
												%></td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%=converterMinutoParaHora(vint_Minutos)%></td>
											</tr>
										...
										ElseIf vint_ContadorRegistroRS = 1 Then
											...
											<tr style="cursor: hand" class="tr<%=contadorClass Mod 2 %>">
												...
												%></td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;</td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;</td>
												<td onclick="AbrirDetalhe(thisForm,'<%=vstr_DataAux%>');">&nbsp;<%
						...
						<td align="middle">
							<table ALIGN="center" BORDER="0" CELLSPACING="1" CELLPADDING="1">
								<tr>
									...
									<!--<td><input type="button" value="Impressão Lote" onclick='imprimirLote(thisForm);' class="BotaoOff" onmouseover="this.className='BotaoOn';" onmouseout="this.className='BotaoOff';" title="Imprimir em Lote"></td>-->
								</tr>
							</table>
						</td>
					</tr>
