...
If	Not Session("sint_TipoUsuario") = "1" And Not Session("sint_TipoUsuario") = "2"  and ("sint_TipoUsuario") = "3" Then
...
<script type="text/javascript" src="js/horasrelatoriofiltro.js"></script>
...
<table class="font" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="VERTICAL-ALIGN: top">
			<form name="thisForm" action="horasrelatorio.asp" method="post">
								...
								<tr>
									...
									<td><%
										...
										If Session("sint_TipoUsuario") = 2 Then
											...
											<input class="TextBox" type="text" maxlength="100" size="30" name="cmbComboUsuario" Value="<%=Session("sstr_DsUsuario")%>" readOnly >
											
											<%
										Else
											
											Call CriarComboUsuario("cmbComboUsuario", vstr_IdUsuario, Empty,Empty)
					...
					<tr>
						<td align="middle">
							<table ALIGN="center" BORDER="0" CELLSPACING="1" CELLPADDING="1">
								<tr>
									<td><input type="button" value="Listar" onclick="listar();" class="BotaoOff" onmouseover="this.className='BotaoOn';" onmouseout="this.className='BotaoOff';" title="Lista horas do mês selecionado"></td>
