			...
			If ValidarForm = True Then
				...
				If Not Trim(vstr_CdUsuario) = Trim(vstr_IdUsuario) Then
					...
					Else
						...
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param9",adChar, adParamInput, 10, converterDataParaSQL(vstr_DtNascimento))
...
<table class="font" width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td style="VERTICAL-ALIGN: top">
			<form name="thisForm" action="usuarioslistagem.asp" method="post">
