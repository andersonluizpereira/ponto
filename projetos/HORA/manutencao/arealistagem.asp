...
<script type="text/javascript" src="js/arealistagem.js"></script>
	...
	<tr>
		<td valign="top">
			<form name="thisForm" action="areamanutencao.asp" method="post">
				...
				<table width="570" height="30" border="0" cellpadding="0" cellspacing="0" class="Tabela">
					<tr>
						<td>
							...
							<COLGROUP>
								...
								<tr class="TituloPagina">
									<td align="left" colspan="3">Área</td>
								</tr>
								<tr class="Cabecalho">
									<td>&#160;</td>
									<td>Sigla</td>
								...
								vobj_command.CommandText					= "consultaAreas"
									...
									Do While Not vobj_rsRegistro.EOF
										...
										<tr style="cursor: hand" class="tr<%=contadorClass Mod 2 %>">
											...
											If CBool(vobj_rsRegistro("FL_ATIVO")) = True Then
												...
												<td onclick="desativar('<%=vobj_rsRegistro("DS_AREA")%>');" title="Desativar Area"><img src="<%=getBaseLink("/images/star_on.gif")%>"></td>
											...
											Else
												...
												<td onclick="ativar('<%=vobj_rsRegistro("DS_AREA")%>');" title="Ativar Area"><img src="<%=getBaseLink("/images/star_off.gif")%>"></td>
											...
											<td onclick="alterar('<%=vobj_rsRegistro("DS_AREA")%>');"><%=vobj_rsRegistro("DS_AREA")%></td>
											<td onclick="alterar('<%=vobj_rsRegistro("DS_AREA")%>');"><%=vobj_rsRegistro("DS_NOME")%></td>
										</tr>
					...
					<tr>
						<td colspan=7 align="middle" >
							<TABLE ALIGN=center BORDER=0 CELLSPACING=1 CELLPADDING=1>
								<TR>
									<TD>
										<INPUT type="button" name="cmdIncluir" value="Incluir" onclick="incluir();" class="BotaoOff" onmouseover="this.className='BotaoOn';" onmouseout="this.className='BotaoOff';" title="Incluir Area">
									</TD>
								</TR>
							</TABLE>
						</td>
