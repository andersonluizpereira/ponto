...
<table class="font" width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<td style="VERTICAL-ALIGN: top">
			<form name="thisForm" action="usuariosmanutencao.asp" method="post">
				...
				<table border="0" class="font" cellpadding="0" cellspacing="0">
					...
					<tr>
						<td colspan="2">
						<fieldset style="LEFT: 0px; WIDTH: 900px; HEIGHT: 180px">
							<legend>
	...
	<option value="4">Consulta</option>
											...
											ElseIf vint_FlPerfil = "3" Then
												
												%>
												<option value="0">Colaborador Nivel - 1</option>
												<option value="2">Colaborador Nivel - 2</option>	
												<option value="1">Administrador</option>
												<option selected value="3">Moderador</option>
	<option value="4">Consulta</option>

	<%
												
											
											ElseIf vint_FlPerfil = "4" Then
												...
												<option value="1">Administrador</option>
												<option  value="3">Moderador</option>
	<option selected value="4">Consulta</option>
...
Private Function ValidarForm()
	...
	End If
       	...
       	If vstr_DsHorasen="" Then

        Call AddErro("Entrada ponto", "Favor, digite a Entrada do ponto(A hora que pessoa entra.)")
        
        End If  
	
        If vstr_DsPer="" Then

        Call AddErro("Periodo de trabalho", "Favor, Entre com a carga horária do dia da pessoa.(Entre 06:00 ou 08:00.)")
        
        End If
	
        If vint_IdEquipe="" Then

        Call AddErro("Equipe que pertence", "Favor, Entre com a equipe que a pessoa pertence.(Caso seja de um outro ambiente sem ser do help center, favor enviar sugestões ao lideres ou coordenadores...)")
