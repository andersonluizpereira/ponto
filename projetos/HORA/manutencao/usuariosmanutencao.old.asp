...
If (vstr_Operacao = "A" or vstr_Operacao = "V") And vstr_Processar <> "S" Then
	...
	If Not vobj_rsRegistro.EOF Then
		...
		vstr_CdUsuario			= Trim(vobj_rsRegistro("ID_USUARIO"))
		vstr_DsUsuario			= Trim(vobj_rsRegistro("DS_USUARIO"))
		vstr_CdSenha			= Trim(vobj_rsRegistro("CD_SENHA"))
			...
			If ValidarForm = True Then
				...
				If Not Trim(vstr_CdUsuario) = Trim(vstr_IdUsuario) Then
					...
					Else
						...
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param6",adInteger, adParamInput,, vint_FlPerfil)
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param7",adChar, adParamInput, 15, EncriptaString(Trim(vstr_CdSenha)))
						
						
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param8",adChar, adParamInput, 10, converterDataParaSQL(vstr_DtNascimento))
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param9",adChar, adParamInput, 20, Trim(vstr_DsTelefone))
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param10",adChar, adParamInput, 15, Trim(vstr_DsRamal))
						vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param11",adChar, adParamInput, 30, Trim(vstr_DsLocalAlocado))
				...
				Else
					...
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param9",adChar, adParamInput, 10, Trim(vstr_DtNascimento))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param10",adChar, adParamInput, 20, Trim(vstr_DsTelefone))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param11",adChar, adParamInput, 15, Trim(vstr_DsRamal))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param12",adChar, adParamInput, 30, Trim(vstr_DsLocalAlocado))
		...
		Case "I"						' Operação de inclusão do registro.
			...
			If ValidarForm = True Then
				...
				Else
					...
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param6",adInteger, adParamInput,, vint_FlPerfil)
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param7",adChar, adParamInput, 15, EncriptaString(Trim(vstr_CdSenha)))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param8",adDate, adParamInput,, converterDataParaSQL(Date()))
