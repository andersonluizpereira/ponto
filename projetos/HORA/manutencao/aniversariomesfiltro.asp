...
<script type="text/javascript" src="js/aniversariomesfiltro.js"></script>
				...
				<table border="0" class="font" cellpadding="0" cellspacing="0">
					<tr>
						...
						<fieldset style="LEFT: 0px; WIDTH: 595px; HEIGHT: 50px">
							<legend>
							   <b>Filtro Aniversariantes Mês</b>
							</legend>
							<TABLE valign="center" class="font" BORDER=0 CELLSPACING=1 CELLPADDING=1>
								<tr>
									...
									<td>&nbsp;&nbsp;&nbsp;</td>
									<td>
										<input class="TextBox" type="hidden" maxlength="4" size="5" name="txtDsAno" Value="<%=Year(Date())%>">
									</td>
								</tr>
							</TABLE>
						</fieldset>
