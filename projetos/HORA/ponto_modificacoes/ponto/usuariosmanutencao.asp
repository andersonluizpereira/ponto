		...
		Case "A"						' Operação de alteração do registro.
			...
			If ValidarForm = True Then
				...
				Else
					...
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param11",adChar, adParamInput, 10, Trim(vstr_DtNascimento))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param12",adChar, adParamInput, 20, Trim(vstr_DsTelefone))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param13",adChar, adParamInput, 15, Trim(vstr_DsRamal))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param14",adChar, adParamInput, 30, Trim(vstr_DsLocalAlocado))
		...
		Case "I"						' Operação de inclusão do registro.
			...
			If ValidarForm = True Then
				...
				Else
					...
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param8",adInteger, adParamInput,, vint_FlPerfil)
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param9",adChar, adParamInput, 15, EncriptaString(Trim(vstr_CdSenha)))
					vobj_commandProc.Parameters.Append vobj_commandProc.CreateParameter("param10",adDate, adParamInput,, converterDataParaSQL(Date()))
